/***
 * Copyright 2020 by Vinh T. Nguyen
 */
$(function () {
    'use strict'
    ...
    "nodes": [
        {
            "id": "3742",
            "comment": ["GLIO"],
            "community": ["Calcium signaling pathway", "Glioma", "HIF-1 signaling pathway", "Melanogenesis", "Wnt signaling pathway", "ErbB signaling pathway"],
            "type": "circle",
            "label": "CAMK2A",
            "tag": "gene",
        ...
        },
        {
            "id": "3741",
            "comment": ["GLIO"],
            "community": ["Calcium signaling pathway", "Melanogenesis", "Glioma", "Estrogen signaling pathway"],
            "type": "circle",
            "label": "CALML6",
            "tag": "gene",
        ...
        },
        {
            "id": "3740",
            "comment": ["GLIO"],
            "community": ["Melanoma", "Calcium signaling pathway", "Glioma", "Prostate cancer", "Focal adhesion", "MAPK signaling pathway", "Cytokine-cytokine receptor interaction", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "PDGFRA",
            "tag": "gene",
        ...
        },
        {
            "id": "3739",
            "comment": ["GLIO"],
            "community": ["Melanoma", "Glioma", "Prostate cancer", "Focal adhesion", "MAPK signaling pathway", "Cytokine-cytokine receptor interaction", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "PDGFA",
            "tag": "gene",
        ...
        },
        {
            "id": "3737",
            "comment": ["ENDO"],
            "community": ["Endometrial cancer", "ErbB signaling pathway", "Focal adhesion", "MAPK signaling pathway"],
            "type": "circle",
            "label": "ELK1",
            "tag": "gene",
        ...
        },
        {
            "id": "3736",
            "comment": ["ENDO"],
            "community": ["PPAR signaling pathway", "Focal adhesion", "Endometrial cancer"],
            "type": "circle",
            "label": "ILK",
            "tag": "gene",
        ...
        },
        {
            "id": "3735",
            "comment": ["ENDO"],
            "community": ["Endometrial cancer", "Adherens junction"],
            "type": "circle",
            "label": "CTNNA1",
            "tag": "gene",
        ...
        },
        {
            "id": "3732",
            "comment": ["COLO"],
            "community": ["Colorectal cancer", "p53 signaling pathway", "Apoptosis"],
            "type": "circle",
            "label": "BAX",
            "tag": "gene",
        ...
        },
        {
            "id": "3730",
            "comment": ["COLO"],
            "community": ["Apoptosis", "Colorectal cancer"],
            "type": "circle",
            "label": "BIRC5",
            "tag": "gene",
        ...
        },
        {
            "id": "3729",
            "comment": ["COLO"],
            "community": ["Colorectal cancer", "Focal adhesion", "Wnt signaling pathway", "TGF-beta signaling pathway", "Adherens junction", "mTOR signaling pathway"],
            "type": "circle",
            "label": "RHOA",
            "tag": "gene",
        ...
        },
        {
            "id": "3727",
            "comment": ["COLO", "ENDO"],
            "community": ["Endometrial cancer", "Colorectal cancer"],
            "type": "circle",
            "label": "MLH1",
            "tag": "gene",
        ...
        },
        {
            "id": "3725",
            "comment": ["COLO"],
            "community": ["Apoptosis", "Colorectal cancer", "p53 signaling pathway", "MAPK signaling pathway"],
            "type": "circle",
            "label": "CASP3",
            "tag": "gene",
        ...
        },
        {
            "id": "3721",
            "comment": ["PANC"],
            "community": ["Pancreatic cancer", "Homologous recombination"],
            "type": "circle",
            "label": "RAD51",
            "tag": "gene",
        ...
        },
        {
            "id": "3720",
            "comment": ["PANC", "COLO"],
            "community": ["TGF-beta signaling pathway", "Cell cycle", "Adherens junction", "Pancreatic cancer", "Colorectal cancer"],
            "type": "circle",
            "label": "SMAD2",
            "tag": "gene",
        ...
        },
        {
            "id": "3719",
            "comment": ["PANC"],
            "community": ["Pancreatic cancer", "Jak-STAT signaling pathway"],
            "type": "circle",
            "label": "STAT1",
            "tag": "gene",
        ...
        },
        {
            "id": "3718",
            "comment": ["PANC"],
            "community": ["Pancreatic cancer", "Jak-STAT signaling pathway", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "JAK1",
            "tag": "gene",
        ...
        },
        {
            "id": "3717",
            "comment": ["COLO", "PANC"],
            "community": ["Focal adhesion", "Pancreatic cancer", "Colorectal cancer", "Apoptosis", "Wnt signaling pathway", "MAPK signaling pathway", "ErbB signaling pathway"],
            "type": "circle",
            "label": "MAPK8",
            "tag": "gene",
        ...
        },
        {
            "id": "3713",
            "comment": ["PANC", "COLO"],
            "community": ["Pancreatic cancer", "Colorectal cancer"],
            "type": "circle",
            "label": "RALGDS",
            "tag": "gene",
        ...
        },
        {
            "id": "3710",
            "comment": ["BRCA"],
            "community": ["Focal adhesion", "Breast cancer", "Cytokine-cytokine receptor interaction", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "FLT4",
            "tag": "gene",
        ...
        },
        {
            "id": "3708",
            "comment": ["BRCA"],
            "community": ["Notch signaling pathway", "Breast cancer"],
            "type": "circle",
            "label": "HES1",
            "tag": "gene",
        ...
        },
        {
            "id": "3707",
            "comment": ["BRCA"],
            "community": ["Melanoma", "Breast cancer", "MAPK signaling pathway", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "FGF1",
            "tag": "gene",
        ...
        },
        {
            "id": "3706",
            "comment": ["BRCA", "PANC"],
            "community": ["Pancreatic cancer", "Homologous recombination", "Breast cancer"],
            "type": "circle",
            "label": "BRCA2",
            "tag": "gene",
        ...
        },
        {
            "id": "3705",
            "comment": ["BRCA"],
            "community": ["Homologous recombination", "Breast cancer", "Ubiquitin mediated proteolysis", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "BRCA1",
            "tag": "gene",
        ...
        },
        {
            "id": "3704",
            "comment": ["BRCA"],
            "community": ["Breast cancer", "Cytokine-cytokine receptor interaction"],
            "type": "circle",
            "label": "TNFSF11",
            "tag": "gene",
        ...
        },
        {
            "id": "3703",
            "comment": ["BRCA"],
            "community": ["Basal cell carcinoma", "Breast cancer", "Melanogenesis", "Wnt signaling pathway", "mTOR signaling pathway"],
            "type": "circle",
            "label": "WNT4",
            "tag": "gene",
        ...
        },
        {
            "id": "3702",
            "comment": ["BRCA"],
            "community": ["Prostate cancer", "Breast cancer", "MAPK signaling pathway", "Adherens junction", "PI3K-Akt signaling pathway", "Melanoma"],
            "type": "circle",
            "label": "FGFR1",
            "tag": "gene",
        ...
        },
        {
            "id": "3701",
            "comment": ["BRCA"],
            "community": ["Breast cancer", "MAPK signaling pathway"],
            "type": "circle",
            "label": "NFKB2",
            "tag": "gene",
        ...
        },
        {
            "id": "3700",
            "comment": ["BRCA"],
            "community": ["Breast cancer", "Wnt signaling pathway", "mTOR signaling pathway"],
            "type": "circle",
            "label": "LRP6",
            "tag": "gene",
        ...
        },
        {
            "id": "3699",
            "comment": ["BRCA"],
            "community": ["Breast cancer", "Wnt signaling pathway"],
            "type": "circle",
            "label": "FRAT1",
            "tag": "gene",
        ...
        },
        {
            "id": "3698",
            "comment": ["BRCA"],
            "community": ["Wnt signaling pathway", "Breast cancer", "Hedgehog signaling pathway"],
            "type": "circle",
            "label": "CSNK1A1L",
            "tag": "gene",
        ...
        },
        {
            "id": "3694",
            "comment": ["BRCA"],
            "community": ["Breast cancer", "Notch signaling pathway"],
            "type": "circle",
            "label": "DLL3",
            "tag": "gene",
        ...
        },
        {
            "id": "3693",
            "comment": ["COLO", "BRCA"],
            "community": ["Colorectal cancer", "Estrogen signaling pathway", "Apoptosis", "Breast cancer", "MAPK signaling pathway"],
            "type": "circle",
            "label": "FOS",
            "tag": "gene",
        ...
        },
        {
            "id": "3692",
            "comment": ["GLIO", "BRCA"],
            "community": ["Focal adhesion", "Melanoma", "Glioma", "Prostate cancer", "Breast cancer", "HIF-1 signaling pathway", "mTOR signaling pathway", "PI3K-Akt signaling pathway", "Adherens junction"],
            "type": "circle",
            "label": "IGF1R",
            "tag": "gene",
        ...
        },
        {
            "id": "3691",
            "comment": ["BRCA", "GLIO"],
            "community": ["Focal adhesion", "Melanoma", "Glioma", "Prostate cancer", "HIF-1 signaling pathway", "p53 signaling pathway", "mTOR signaling pathway", "PI3K-Akt signaling pathway", "Breast cancer"],
            "type": "circle",
            "label": "IGF1",
            "tag": "gene",
        ...
        },
        {
            "id": "3685",
            "comment": ["BRCA"],
            "community": ["Breast cancer", "Estrogen signaling pathway"],
            "type": "circle",
            "label": "ESR1",
            "tag": "gene",
        ...
        },
        {
            "id": "3679",
            "comment": ["RENA"],
            "community": ["Melanoma", "Focal adhesion", "Renal cell carcinoma", "Cytokine-cytokine receptor interaction", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "HGF",
            "tag": "gene",
        ...
        },
        {
            "id": "3678",
            "comment": ["COLO", "RENA"],
            "community": ["Colorectal cancer", "Renal cell carcinoma", "Focal adhesion", "Apoptosis", "Wnt signaling pathway", "Estrogen signaling pathway", "Breast cancer", "ErbB signaling pathway", "MAPK signaling pathway"],
            "type": "circle",
            "label": "JUN",
            "tag": "gene",
        ...
        },
        {
            "id": "3677",
            "comment": ["RENA"],
            "community": ["Renal cell carcinoma"],
            "type": "circle",
            "label": "ETS1",
            "tag": "gene",
        ...
        },
        {
            "id": "3676",
            "comment": ["RENA"],
            "community": ["Pancreatic cancer", "Renal cell carcinoma", "Focal adhesion", "MAPK signaling pathway", "VEGF signaling pathway", "Adherens junction"],
            "type": "circle",
            "label": "CDC42",
            "tag": "gene",
        ...
        },
        {
            "id": "3675",
            "comment": ["RENA"],
            "community": ["Renal cell carcinoma", "Focal adhesion", "MAPK signaling pathway"],
            "type": "circle",
            "label": "RAP1A",
            "tag": "gene",
        ...
        },
        {
            "id": "3674",
            "comment": ["RENA"],
            "community": ["Renal cell carcinoma", "ErbB signaling pathway", "Focal adhesion"],
            "type": "circle",
            "label": "PAK4",
            "tag": "gene",
        ...
        },
        {
            "id": "3673",
            "comment": ["RENA"],
            "community": ["Renal cell carcinoma", "ErbB signaling pathway"],
            "type": "circle",
            "label": "GAB1",
            "tag": "gene",
        ...
        },
        {
            "id": "3672",
            "comment": ["RENA"],
            "community": ["Melanoma", "Renal cell carcinoma", "Focal adhesion", "Cytokine-cytokine receptor interaction", "PI3K-Akt signaling pathway", "Adherens junction"],
            "type": "circle",
            "label": "MET",
            "tag": "gene",
        ...
        },
        {
            "id": "3671",
            "comment": ["RENA"],
            "community": ["Renal cell carcinoma", "Focal adhesion"],
            "type": "circle",
            "label": "RAPGEF1",
            "tag": "gene",
        ...
        },
        {
            "id": "3670",
            "comment": ["PANC", "RENA"],
            "community": ["Pancreatic cancer", "Colorectal cancer", "Renal cell carcinoma", "Focal adhesion", "VEGF signaling pathway", "Wnt signaling pathway", "Adherens junction", "MAPK signaling pathway", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "RAC1",
            "tag": "gene",
        ...
        },
        {
            "id": "3669",
            "comment": ["RENA"],
            "community": ["Renal cell carcinoma", "Citrate cycle (TCA cycle)"],
            "type": "circle",
            "label": "FH",
            "tag": "gene",
        ...
        },
        {
            "id": "3668",
            "comment": ["RENA"],
            "community": ["Renal cell carcinoma", "mTOR signaling pathway"],
            "type": "circle",
            "label": "FLCN",
            "tag": "gene",
        ...
        },
        {
            "id": "3667",
            "comment": ["RENA"],
            "community": ["Melanoma", "Renal cell carcinoma", "Glioma", "Prostate cancer", "Focal adhesion", "MAPK signaling pathway", "Cytokine-cytokine receptor interaction", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "PDGFB",
            "tag": "gene",
        ...
        },
        {
            "id": "3662",
            "comment": ["RENA"],
            "community": ["HIF-1 signaling pathway", "Renal cell carcinoma"],
            "type": "circle",
            "label": "EGLN2",
            "tag": "gene",
        ...
        },
        {
            "id": "3661",
            "comment": ["RENA"],
            "community": ["HIF-1 signaling pathway", "Renal cell carcinoma", "Ubiquitin mediated proteolysis"],
            "type": "circle",
            "label": "VHL",
            "tag": "gene",
        ...
        },
        {
            "id": "3660",
            "comment": ["RENA"],
            "community": ["HIF-1 signaling pathway", "Ubiquitin mediated proteolysis", "Renal cell carcinoma"],
            "type": "circle",
            "label": "TCEB1",
            "tag": "gene",
        ...
        },
        {
            "id": "3658",
            "comment": ["RENA"],
            "community": ["TGF-beta signaling pathway", "Cell cycle", "Renal cell carcinoma", "HIF-1 signaling pathway", "Ubiquitin mediated proteolysis", "Wnt signaling pathway"],
            "type": "circle",
            "label": "RBX1",
            "tag": "gene",
        ...
        },
        {
            "id": "3654",
            "comment": ["nSCLC"],
            "community": ["Non-small cell lung cancer"],
            "type": "circle",
            "label": "ALK",
            "tag": "gene",
        ...
        },
        {
            "id": "3651",
            "comment": ["nSCLC"],
            "community": ["Estrogen signaling pathway", "Melanoma", "Jak-STAT signaling pathway", "Endometrial cancer", "PI3K-Akt signaling pathway", "Breast cancer", "Small cell lung cancer", "Acute myeloid leukemia", "Chronic myeloid leukemia", "mTOR signaling pathway", "Glioma", "Pancreatic cancer", "Colorectal cancer", "Renal cell carcinoma", "Prostate cancer", "Focal adhesion", "HIF-1 signaling pathway", "Apoptosis", "VEGF signaling pathway", "Non-small cell lung cancer", "ErbB signaling pathway"],
            "type": "circle",
            "label": "PIK3CA",
            "tag": "gene",
        ...
        },
        {
            "id": "3649",
            "comment": ["nSCLC"],
            "community": ["Non-small cell lung cancer", "MAPK signaling pathway"],
            "type": "circle",
            "label": "STK4",
            "tag": "gene",
        ...
        {
            "id": "3648",
            "comment": ["GLIO", "PANC", "RENA", "nSCLC"],
            "community": ["Pancreatic cancer", "Renal cell carcinoma", "Glioma", "Prostate cancer", "Non-small cell lung cancer", "ErbB signaling pathway"],
            "type": "circle",
            "label": "TGFA",
            "tag": "gene",
        ...
        },
        {
            "id": "3647",
            "comment": ["GLIO", "nSCLC"],
            "community": ["Calcium signaling pathway", "Glioma", "HIF-1 signaling pathway", "VEGF signaling pathway", "ErbB signaling pathway", "Non-small cell lung cancer"],
            "type": "circle",
            "label": "PLCG1",
            "tag": "gene",
        ...
        },
        {
            "id": "3646",
            "comment": ["nSCLC", "ENDO"],
            "community": ["Non-small cell lung cancer", "Endometrial cancer", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "FOXO3",
            "tag": "gene",
        ...
        },
        {
            "id": "3642",
            "comment": ["nSCLC", "GLIO"],
            "community": ["Melanogenesis", "Focal adhesion", "Calcium signaling pathway", "Glioma", "HIF-1 signaling pathway", "mTOR signaling pathway", "PI3K-Akt signaling pathway", "Wnt signaling pathway", "VEGF signaling pathway", "ErbB signaling pathway", "MAPK signaling pathway", "Non-small cell lung cancer"],
            "type": "circle",
            "label": "PRKCA",
            "tag": "gene",
        ...
        },
        {
            "id": "3641",
            "comment": ["SCLC"],
            "community": ["TGF-beta signaling pathway", "Small cell lung cancer", "Cell cycle"],
            "type": "circle",
            "label": "CDKN2B",
            "tag": "gene",
        ...
        },
        {
            "id": "3640",
            "comment": ["SCLC"],
            "community": ["Cell cycle", "Ubiquitin mediated proteolysis", "mTOR signaling pathway", "Small cell lung cancer"],
            "type": "circle",
            "label": "SKP2",
            "tag": "gene",
        ...
        },
        {
            "id": "3639",
            "comment": ["SCLC"],
            "community": ["Apoptosis", "Small cell lung cancer"],
            "type": "circle",
            "label": "TRAF1",
            "tag": "gene",
        ...
        },
        {
            "id": "3638",
            "comment": ["SCLC"],
            "community": ["VEGF signaling pathway", "Small cell lung cancer"],
            "type": "circle",
            "label": "PTGS2",
            "tag": "gene",
        ...
        },
        {
            "id": "3637",
            "comment": ["SCLC"],
            "community": ["Calcium signaling pathway", "Small cell lung cancer", "HIF-1 signaling pathway"],
            "type": "circle",
            "label": "NOS2",
            "tag": "gene",
        ...
        },
        {
            "id": "3636",
            "comment": ["SCLC"],
            "community": ["Ubiquitin mediated proteolysis", "Small cell lung cancer"],
            "type": "circle",
            "label": "BIRC8",
            "tag": "gene",
        ...
        },
        {
            "id": "3634",
            "comment": ["SCLC"],
            "community": ["Small cell lung cancer", "Focal adhesion", "ECM-receptor interaction", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "LAMC3",
            "tag": "gene",
        ...
        },
        {
            "id": "3633",
            "comment": ["COLO", "SCLC"],
            "community": ["Colorectal cancer", "p53 signaling pathway", "Small cell lung cancer", "Apoptosis"],
            "type": "circle",
            "label": "CYCS",
            "tag": "gene",
        ...
        },
        {
            "id": "3632",
            "comment": ["nSCLC", "SCLC"],
            "community": ["Non-small cell lung cancer", "Small cell lung cancer"],
            "type": "circle",
            "label": "FHIT",
            "tag": "gene",
        ...
        },
        {
            "id": "3631",
            "comment": ["SCLC"],
            "community": ["Small cell lung cancer", "Focal adhesion", "VEGF signaling pathway", "PI3K-Akt signaling pathway", "ErbB signaling pathway"],
            "type": "circle",
            "label": "PTK2",
            "tag": "gene",
        ...
        },
        {
            "id": "3630",
            "comment": ["SCLC"],
            "community": ["MAPK signaling pathway", "Small cell lung cancer"],
            "type": "circle",
            "label": "MAX",
            "tag": "gene",
        ...
        },
        {
            "id": "3629",
            "comment": ["SCLC"],
            "community": ["p53 signaling pathway", "Small cell lung cancer", "Apoptosis"],
            "type": "circle",
            "label": "APAF1",
            "tag": "gene",
        ...
        },
        {
            "id": "3628",
            "comment": ["SCLC"],
            "community": ["Small cell lung cancer"],
            "type": "circle",
            "label": "CKS1B",
            "tag": "gene",
        ...
        },
        {
            "id": "3625",
            "comment": ["SCLC"],
            "community": ["Ubiquitin mediated proteolysis", "Small cell lung cancer", "Jak-STAT signaling pathway"],
            "type": "circle",
            "label": "PIAS2",
            "tag": "gene",
        ...
        },
        {
            "id": "3624",
            "comment": ["SCLC"],
            "community": ["Hematopoietic cell lineage", "ECM-receptor interaction", "Small cell lung cancer", "Focal adhesion", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "ITGA6",
            "tag": "gene",
        ...
        },
        {
            "id": "3623",
            "comment": ["SCLC"],
            "community": ["ECM-receptor interaction", "Small cell lung cancer", "Focal adhesion", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "ITGB1",
            "tag": "gene",
        ...
        },
        {
            "id": "3619",
            "comment": ["AMLE"],
            "community": ["HIF-1 signaling pathway", "ErbB signaling pathway", "Acute myeloid leukemia", "PI3K-Akt signaling pathway", "mTOR signaling pathway"],
            "type": "circle",
            "label": "EIF4EBP1",
            "tag": "gene",
        ...
        },
        {
            "id": "3618",
            "comment": ["BRCA", "AMLE"],
            "community": ["Hematopoietic cell lineage", "Breast cancer", "Melanogenesis", "Acute myeloid leukemia", "Cytokine-cytokine receptor interaction", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "KIT",
            "tag": "gene",
        ...
        },
        {
            "id": "3617",
            "comment": ["BRCA", "AMLE"],
            "community": ["TGF-beta signaling pathway", "Breast cancer", "Acute myeloid leukemia", "HIF-1 signaling pathway", "mTOR signaling pathway", "PI3K-Akt signaling pathway", "ErbB signaling pathway"],
            "type": "circle",
            "label": "RPS6KB1",
            "tag": "gene",
        ...
        },
        {
            "id": "3616",
            "comment": ["AMLE"],
            "community": ["Acute myeloid leukemia"],
            "type": "circle",
            "label": "PIM2",
            "tag": "gene",
        ...
        },
        {
            "id": "3615",
            "comment": ["AMLE"],
            "community": ["Jak-STAT signaling pathway", "Acute myeloid leukemia"],
            "type": "circle",
            "label": "PIM1",
            "tag": "gene",
        ...
        },
        {
            "id": "3614",
            "comment": ["AMLE"],
            "community": ["Acute myeloid leukemia", "Ubiquitin mediated proteolysis"],
            "type": "circle",
            "label": "PML",
            "tag": "gene",
        ...
        },
        {
            "id": "3613",
            "comment": ["AMLE"],
            "community": ["Cell cycle", "Acute myeloid leukemia"],
            "type": "circle",
            "label": "CCNA1",
            "tag": "gene",
        ...
        },
        {
            "id": "3611",
            "comment": ["AMLE", "PANC"],
            "community": ["Acute myeloid leukemia", "Pancreatic cancer", "Jak-STAT signaling pathway", "Non-small cell lung cancer", "HIF-1 signaling pathway"],
            "type": "circle",
            "label": "STAT3",
            "tag": "gene",
        ...
        },
        {
            "id": "3610",
            "comment": ["AMLE"],
            "community": ["PPAR signaling pathway", "Wnt signaling pathway", "Acute myeloid leukemia"],
            "type": "circle",
            "label": "PPARD",
            "tag": "gene",
        ...
        },
        {
            "id": "3607",
            "comment": ["AMLE"],
            "community": ["Acute myeloid leukemia", "Chronic myeloid leukemia"],
            "type": "circle",
            "label": "RUNX1",
            "tag": "gene",
        ...
        },
        {
            "id": "3604",
            "comment": ["AMLE"],
            "community": ["Acute myeloid leukemia", "Hematopoietic cell lineage", "Cytokine-cytokine receptor interaction"],
            "type": "circle",
            "label": "FLT3",
            "tag": "gene",
        ...
        {
            "id": "3603",
            "comment": ["nSCLC", "COLO", "PANC", "AMLE", "ENDO"],
            "community": ["Chronic myeloid leukemia", "Melanoma", "Endometrial cancer", "PI3K-Akt signaling pathway", "Breast cancer", "Non-small cell lung cancer", "ErbB signaling pathway", "Acute myeloid leukemia", "Estrogen signaling pathway", "mTOR signaling pathway", "MAPK signaling pathway", "Bladder cancer", "Pancreatic cancer", "Colorectal cancer", "Renal cell carcinoma", "Thyroid cancer", "Glioma", "Prostate cancer", "Apoptosis", "VEGF signaling pathway", "Melanogenesis"],
            "type": "circle",
            "label": "KRAS",
            "tag": "gene",
        ...
        },
        {
            "id": "3600",
            "comment": ["CMLE"],
            "community": ["TGF-beta signaling pathway", "Pancreatic cancer", "Cell cycle", "Adherens junction", "Chronic myeloid leukemia", "Wnt signaling pathway", "Colorectal cancer"],
            "type": "circle",
            "label": "SMAD3",
            "tag": "gene",
        ...
        },
        {
            "id": "3599",
            "comment": ["CMLE"],
            "community": ["Ubiquitin mediated proteolysis", "Chronic myeloid leukemia", "ErbB signaling pathway"],
            "type": "circle",
            "label": "CBLC",
            "tag": "gene",
        ...
        },
        {
            "id": "3598",
            "comment": ["RENA", "CMLE"],
            "community": ["MAPK signaling pathway", "Renal cell carcinoma", "ErbB signaling pathway", "Focal adhesion", "Chronic myeloid leukemia"],
            "type": "circle",
            "label": "CRK",
            "tag": "gene",
        ...
        },
        {
            "id": "3597",
            "comment": ["CMLE"],
            "community": ["Chronic myeloid leukemia"],
            "type": "circle",
            "label": "GAB2",
            "tag": "gene",
        ...
        {
            "id": "3596",
            "comment": ["CMLE", "GLIO", "BRCA"],
            "community": ["VEGF signaling pathway", "Estrogen signaling pathway", "Glioma", "ErbB signaling pathway", "Focal adhesion", "Chronic myeloid leukemia", "Breast cancer"],
            "type": "circle",
            "label": "SHC2",
            "tag": "gene",
        ...
        },
        {
            "id": "3594",
            "comment": ["CMLE"],
            "community": ["Jak-STAT signaling pathway", "Non-small cell lung cancer", "Acute myeloid leukemia", "Chronic myeloid leukemia", "ErbB signaling pathway"],
            "type": "circle",
            "label": "STAT5A",
            "tag": "gene",
        ...
        },
        {
            "id": "3593",
            "comment": ["PANC", "COLO", "CMLE"],
            "community": ["TGF-beta signaling pathway", "Pancreatic cancer", "Colorectal cancer", "Adherens junction", "Chronic myeloid leukemia", "Cytokine-cytokine receptor interaction", "MAPK signaling pathway"],
            "type": "circle",
            "label": "TGFBR1",
            "tag": "gene",
        ...
        {
            "id": "3592",
            "comment": ["CMLE", "PANC", "COLO"],
            "community": ["TGF-beta signaling pathway", "Pancreatic cancer", "Colorectal cancer", "MAPK signaling pathway", "Adherens junction", "Chronic myeloid leukemia", "Cytokine-cytokine receptor interaction"],
            "type": "circle",
            "label": "TGFBR2",
            "tag": "gene",
        ...
        },
        {
            "id": "3591",
            "comment": ["CMLE"],
            "community": ["Notch signaling pathway", "Wnt signaling pathway", "Chronic myeloid leukemia"],
            "type": "circle",
            "label": "CTBP1",
            "tag": "gene",
        ...
        },
        {
            "id": "3590",
            "comment": ["CMLE"],
            "community": ["Cell cycle", "Notch signaling pathway", "Chronic myeloid leukemia"],
            "type": "circle",
            "label": "HDAC1",
            "tag": "gene",
        ...
        {
            "id": "3589",
            "comment": ["PANC", "CMLE", "RENA", "COLO"],
            "community": ["TGF-beta signaling pathway", "Chronic myeloid leukemia", "Pancreatic cancer", "Colorectal cancer", "Renal cell carcinoma", "Cytokine-cytokine receptor interaction", "MAPK signaling pathway", "Cell cycle"],
            "type": "circle",
            "label": "TGFB1",
            "tag": "gene",
        ...
        },
        {
            "id": "3587",
            "comment": ["CMLE"],
            "community": ["Cell cycle", "ErbB signaling pathway", "Chronic myeloid leukemia"],
            "type": "circle",
            "label": "ABL1",
            "tag": "gene",
        ...
        },
        {
            "id": "3586",
            "comment": ["CMLE", "RENA"],
            "community": ["Renal cell carcinoma", "Jak-STAT signaling pathway", "Chronic myeloid leukemia"],
            "type": "circle",
            "label": "PTPN11",
            "tag": "gene",
        ...
        {
            "id": "3585",
            "comment": ["CMLE", "PANC", "SCLC"],
            "community": ["Pancreatic cancer", "Jak-STAT signaling pathway", "Small cell lung cancer", "Chronic myeloid leukemia", "PI3K-Akt signaling pathway", "Apoptosis"],
            "type": "circle",
            "label": "BCL2L1",
            "tag": "gene",
        ...
        },
        {
            "id": "3584",
            "comment": ["CMLE"],
            "community": ["MAPK signaling pathway", "Chronic myeloid leukemia"],
            "type": "circle",
            "label": "MECOM",
            "tag": "gene",
        ...
        },
        {
            "id": "3583",
            "comment": ["BLAD"],
            "community": ["Bladder cancer", "Focal adhesion", "Estrogen signaling pathway", "VEGF signaling pathway", "ErbB signaling pathway", "Adherens junction"],
            "type": "circle",
            "label": "SRC",
            "tag": "gene",
        ...
        },
        {
            "id": "3582",
            "comment": ["BLAD"],
            "community": ["Bladder cancer", "ErbB signaling pathway", "Estrogen signaling pathway"],
            "type": "circle",
            "label": "HBEGF",
            "tag": "gene",
        ...
        },
        {
            "id": "3580",
            "comment": ["BLAD"],
            "community": ["Bladder cancer", "Estrogen signaling pathway"],
            "type": "circle",
            "label": "MMP2",
            "tag": "gene",
        ...
        },
        {
            "id": "3578",
            "comment": ["BLAD"],
            "community": ["Bladder cancer", "MAPK signaling pathway"],
            "type": "circle",
            "label": "RPS6KA5",
            "tag": "gene",
        ...
        },
        {
            "id": "3577",
            "comment": ["BLAD"],
            "community": ["Bladder cancer", "MAPK signaling pathway", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "FGFR3",
            "tag": "gene",
        ...
        },
        {
            "id": "3575",
            "comment": ["BLAD", "nSCLC"],
            "community": ["Bladder cancer", "Non-small cell lung cancer"],
            "type": "circle",
            "label": "RASSF1",
            "tag": "gene",
        ...
        {
            "id": "3574",
            "comment": ["BRCA", "PANC", "nSCLC", "BLAD", "ENDO"],
            "community": ["Bladder cancer", "Endometrial cancer", "Calcium signaling pathway", "Prostate cancer", "Adherens junction", "Non-small cell lung cancer", "ErbB signaling pathway", "Focal adhesion", "HIF-1 signaling pathway", "Pancreatic cancer", "Breast cancer"],
            "type": "circle",
            "label": "ERBB2",
            "tag": "gene",
        ...
        },
        {
            "id": "3573",
            "comment": ["BLAD"],
            "community": ["TGF-beta signaling pathway", "Bladder cancer", "Focal adhesion", "p53 signaling pathway", "ECM-receptor interaction", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "THBS1",
            "tag": "gene",
        ...
        },
        {
            "id": "3572",
            "comment": ["BLAD"],
            "community": ["Bladder cancer", "Cytokine-cytokine receptor interaction"],
            "type": "circle",
            "label": "CXCL8",
            "tag": "gene",
        ...
        {
            "id": "3571",
            "comment": ["RENA", "PANC", "BLAD"],
            "community": ["VEGF signaling pathway", "Renal cell carcinoma", "Focal adhesion", "HIF-1 signaling pathway", "Cytokine-cytokine receptor interaction", "Pancreatic cancer", "PI3K-Akt signaling pathway", "Bladder cancer"],
            "type": "circle",
            "label": "VEGFA",
            "tag": "gene",
        ...
        },
        {
            "id": "3569",
            "comment": ["BLAD"],
            "community": ["Bladder cancer", "PPAR signaling pathway"],
            "type": "circle",
            "label": "MMP1",
            "tag": "gene",
        ...
        {
            "id": "3565",
            "comment": ["CMLE", "MELA", "BLAD", "GLIO", "PANC", "nSCLC"],
            "community": ["Melanoma", "Bladder cancer", "Pancreatic cancer", "p53 signaling pathway", "Non-small cell lung cancer", "Glioma", "Chronic myeloid leukemia", "Cell cycle"],
            "type": "circle",
            "label": "CDKN2A",
            "tag": "gene",
        ...
        },
        {
            "id": "3564",
            "comment": ["MELA"],
            "community": ["Melanoma", "Melanogenesis"],
            "type": "circle",
            "label": "MITF",
            "tag": "gene",
        ...
        {
            "id": "3563",
            "comment": ["nSCLC", "MELA", "CMLE", "PANC", "GLIO", "BRCA", "SCLC", "BLAD"],
            "community": ["Melanoma", "Bladder cancer", "Glioma", "Pancreatic cancer", "Cell cycle", "p53 signaling pathway", "Breast cancer", "Non-small cell lung cancer", "Small cell lung cancer", "Chronic myeloid leukemia", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "CDK4",
            "tag": "gene",
        ...
        },
        {
            "id": "3562",
            "comment": ["MELA", "AMLE"],
            "community": ["Bladder cancer", "Chronic myeloid leukemia", "Thyroid cancer", "Melanoma", "Glioma", "Prostate cancer", "mTOR signaling pathway", "Endometrial cancer", "Apoptosis", "Renal cell carcinoma", "VEGF signaling pathway", "Breast cancer", "ErbB signaling pathway", "Acute myeloid leukemia", "Estrogen signaling pathway", "PI3K-Akt signaling pathway", "Non-small cell lung cancer", "MAPK signaling pathway", "Melanogenesis"],
            "type": "circle",
            "label": "NRAS",
            "tag": "gene",
        ...
        },
        {
            "id": "3556",
            "comment": ["BASA"],
            "community": ["Basal cell carcinoma"],
            "type": "circle",
            "label": "STK36",
            "tag": "gene",
        ...
        },
        {
            "id": "3553",
            "comment": ["BASA", "BRCA"],
            "community": ["Basal cell carcinoma", "Notch signaling pathway", "Breast cancer", "Melanogenesis", "Wnt signaling pathway", "mTOR signaling pathway"],
            "type": "circle",
            "label": "DVL1",
            "tag": "gene",
        ...
        {
            "id": "3552",
            "comment": ["COLO", "ENDO", "BRCA", "BASA"],
            "community": ["Endometrial cancer", "Colorectal cancer", "Basal cell carcinoma", "Breast cancer", "Wnt signaling pathway"],
            "type": "circle",
            "label": "AXIN1",
            "tag": "gene",
        ...
        },
        {
            "id": "3547",
            "comment": ["BASA"],
            "community": ["TGF-beta signaling pathway", "Cytokine-cytokine receptor interaction", "Basal cell carcinoma"],
            "type": "circle",
            "label": "BMP2",
            "tag": "gene",
        ...
        {
            "id": "3536",
            "comment": ["ENDO", "BLAD", "THYR", "MELA"],
            "community": ["Melanoma", "Endometrial cancer", "Thyroid cancer", "Adherens junction", "Bladder cancer"],
            "type": "circle",
            "label": "CDH1",
            "tag": "gene",
        ...
        {
            "id": "3535",
            "comment": ["BRCA", "CMLE", "BLAD", "COLO", "THYR", "ENDO", "AMLE", "SCLC"],
            "community": ["TGF-beta signaling pathway", "Bladder cancer", "Endometrial cancer", "Colorectal cancer", "Thyroid cancer", "Jak-STAT signaling pathway", "Breast cancer", "ErbB signaling pathway", "Acute myeloid leukemia", "MAPK signaling pathway", "PI3K-Akt signaling pathway", "Chronic myeloid leukemia", "Cell cycle", "Wnt signaling pathway", "Small cell lung cancer"],
            "type": "circle",
            "label": "MYC",
            "tag": "gene",
        ...
        {
            "id": "3534",
            "comment": ["SCLC", "THYR", "nSCLC"],
            "community": ["PPAR signaling pathway", "Thyroid cancer", "Non-small cell lung cancer", "Small cell lung cancer", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "RXRA",
            "tag": "gene",
        ...
        },
        {
            "id": "3533",
            "comment": ["THYR", "MELA"],
            "community": ["Melanoma", "Bladder cancer", "Focal adhesion", "Pancreatic cancer", "Colorectal cancer", "Renal cell carcinoma", "Thyroid cancer", "Prostate cancer", "Endometrial cancer", "Breast cancer", "Non-small cell lung cancer", "Glioma", "Acute myeloid leukemia", "Chronic myeloid leukemia", "mTOR signaling pathway", "MAPK signaling pathway", "ErbB signaling pathway"],
            "type": "circle",
            "label": "BRAF",
            "tag": "gene",
        ...
        },
        {
            "id": "3532",
            "comment": ["THYR"],
            "community": ["PPAR signaling pathway", "Thyroid cancer"],
            "type": "circle",
            "label": "PPARG",
            "tag": "gene",
        ...
        {
            "id": "3530",
            "comment": ["ENDO", "nSCLC", "PROS", "BRCA", "AMLE", "BLAD", "COLO", "GLIO", "RENA", "PANC", "CMLE", "MELA"],
            "community": ["Melanoma", "Bladder cancer", "Pancreatic cancer", "Colorectal cancer", "Renal cell carcinoma", "Glioma", "Prostate cancer", "Breast cancer", "Non-small cell lung cancer", "ErbB signaling pathway", "Acute myeloid leukemia", "Chronic myeloid leukemia", "Endometrial cancer"],
            "type": "circle",
            "label": "ARAF",
            "tag": "gene",
        ...
        {
            "id": "3529",
            "comment": ["ENDO", "nSCLC", "COLO", "PROS", "BRCA", "AMLE", "BLAD", "GLIO", "THYR", "RENA", "PANC", "CMLE", "MELA"],
            "community": ["Estrogen signaling pathway", "Melanoma", "Pancreatic cancer", "Endometrial cancer", "PI3K-Akt signaling pathway", "Glioma", "Breast cancer", "Non-small cell lung cancer", "ErbB signaling pathway", "Acute myeloid leukemia", "Chronic myeloid leukemia", "mTOR signaling pathway", "MAPK signaling pathway", "Bladder cancer", "Colorectal cancer", "Renal cell carcinoma", "Thyroid cancer", "Prostate cancer", "Focal adhesion", "HIF-1 signaling pathway", "Apoptosis", "VEGF signaling pathway", "Melanogenesis"],
            "type": "circle",
            "label": "MAP2K1",
            "tag": "gene",
        ...
        {
            "id": "3528",
            "comment": ["ENDO", "nSCLC", "COLO", "BRCA", "PROS", "AMLE", "GLIO", "BLAD", "THYR", "PANC", "RENA", "CMLE", "MELA"],
            "community": ["Acute myeloid leukemia", "Estrogen signaling pathway", "Melanoma", "Pancreatic cancer", "Endometrial cancer", "TGF-beta signaling pathway", "Glioma", "Breast cancer", "Melanogenesis", "ErbB signaling pathway", "MAPK signaling pathway", "mTOR signaling pathway", "PI3K-Akt signaling pathway", "Bladder cancer", "Focal adhesion", "Colorectal cancer", "Renal cell carcinoma", "Thyroid cancer", "Prostate cancer", "HIF-1 signaling pathway", "Apoptosis", "Chronic myeloid leukemia", "VEGF signaling pathway", "Adherens junction", "Non-small cell lung cancer"],
            "type": "circle",
            "label": "MAPK1",
            "tag": "gene",
        ...
        {
            "id": "3525",
            "comment": ["BRCA", "CMLE", "MELA", "PANC", "nSCLC", "ENDO", "SCLC", "PROS", "GLIO", "AMLE", "COLO", "RENA"],
            "community": ["PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "PIK3R5",
            "tag": "gene",
        ...
        {
            "id": "3524",
            "comment": ["RENA", "PANC", "CMLE", "MELA", "nSCLC", "ENDO", "PROS", "GLIO", "SCLC", "BRCA", "AMLE", "COLO"],
            "community": ["Chronic myeloid leukemia", "Melanoma", "Jak-STAT signaling pathway", "Pancreatic cancer", "Glioma", "Breast cancer", "Non-small cell lung cancer", "Small cell lung cancer", "Acute myeloid leukemia", "Estrogen signaling pathway", "mTOR signaling pathway", "PI3K-Akt signaling pathway", "MAPK signaling pathway", "Endometrial cancer", "Colorectal cancer", "Renal cell carcinoma", "Prostate cancer", "Focal adhesion", "HIF-1 signaling pathway", "Apoptosis", "VEGF signaling pathway", "ErbB signaling pathway"],
            "type": "circle",
            "label": "AKT3",
            "tag": "gene",
        ...
        {
            "id": "3522",
            "comment": ["BRCA", "PROS", "AMLE", "GLIO"],
            "community": ["Glioma", "Jak-STAT signaling pathway", "Acute myeloid leukemia", "HIF-1 signaling pathway", "mTOR signaling pathway", "Prostate cancer", "Breast cancer", "PI3K-Akt signaling pathway", "ErbB signaling pathway"],
            "type": "circle",
            "label": "MTOR",
            "tag": "gene",
        ...
        },
        {
            "id": "3521",
            "comment": ["PROS"],
            "community": ["Estrogen signaling pathway", "Prostate cancer", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "HSP90AA1",
            "tag": "gene",
        ...
        {
            "id": "3520",
            "comment": ["BASA", "BRCA", "ENDO", "PROS", "COLO"],
            "community": ["Hedgehog signaling pathway", "Endometrial cancer", "Colorectal cancer", "Basal cell carcinoma", "Prostate cancer", "Focal adhesion", "mTOR signaling pathway", "Wnt signaling pathway", "Cell cycle", "Breast cancer", "Melanogenesis", "ErbB signaling pathway", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "GSK3B",
            "tag": "gene",
        ...
        {
            "id": "3518",
            "comment": ["nSCLC", "GLIO", "ENDO", "CMLE", "BRCA", "PROS", "AMLE", "RENA"],
            "community": ["Focal adhesion", "Chronic myeloid leukemia", "Glioma", "Jak-STAT signaling pathway", "Endometrial cancer", "Renal cell carcinoma", "Breast cancer", "ErbB signaling pathway", "Acute myeloid leukemia", "Estrogen signaling pathway", "Prostate cancer", "mTOR signaling pathway", "PI3K-Akt signaling pathway", "MAPK signaling pathway", "Non-small cell lung cancer"],
            "type": "circle",
            "label": "GRB2",
            "tag": "gene",
        ...
        {
            "id": "3517",
            "comment": ["GLIO", "nSCLC", "ENDO", "CMLE", "BRCA", "PROS", "AMLE", "RENA"],
            "community": ["Focal adhesion", "Chronic myeloid leukemia", "Glioma", "Jak-STAT signaling pathway", "Endometrial cancer", "Renal cell carcinoma", "Breast cancer", "ErbB signaling pathway", "Acute myeloid leukemia", "Estrogen signaling pathway", "Prostate cancer", "mTOR signaling pathway", "PI3K-Akt signaling pathway", "MAPK signaling pathway", "Non-small cell lung cancer"],
            "type": "circle",
            "label": "SOS1",
            "tag": "gene",
        ...
        {
            "id": "3516",
            "comment": ["nSCLC", "ENDO", "PROS"],
            "community": ["Focal adhesion", "Endometrial cancer", "PPAR signaling pathway", "Prostate cancer", "mTOR signaling pathway", "PI3K-Akt signaling pathway", "Non-small cell lung cancer", "Apoptosis"],
            "type": "circle",
            "label": "PDPK1",
            "tag": "gene",
        ...
        {
            "id": "3515",
            "comment": ["nSCLC", "PANC", "GLIO", "SCLC", "MELA", "BRCA", "CMLE", "PROS", "BLAD"],
            "community": ["Melanoma", "Bladder cancer", "Pancreatic cancer", "Cell cycle", "Glioma", "Prostate cancer", "Breast cancer", "Non-small cell lung cancer", "Chronic myeloid leukemia", "Small cell lung cancer"],
            "type": "circle",
            "label": "RB1",
            "tag": "gene",
        ...
        {
            "id": "3514",
            "comment": ["MELA", "GLIO", "PANC", "nSCLC", "BLAD", "ENDO", "BRCA", "PROS"],
            "community": ["Melanoma", "Bladder cancer", "Focal adhesion", "Pancreatic cancer", "Endometrial cancer", "Glioma", "Prostate cancer", "Breast cancer", "Non-small cell lung cancer", "MAPK signaling pathway", "HIF-1 signaling pathway", "Cytokine-cytokine receptor interaction", "PI3K-Akt signaling pathway", "ErbB signaling pathway"],
            "type": "circle",
            "label": "EGF",
            "tag": "gene",
        ...
        },
        {
            "id": "3513",
            "comment": ["SCLC", "PROS"],
            "community": ["Cell cycle", "p53 signaling pathway", "Small cell lung cancer", "Prostate cancer", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "CCNE1",
            "tag": "gene",
        ...
        },
        {
            "id": "3512",
            "comment": ["PROS"],
            "community": ["Prostate cancer", "Estrogen signaling pathway", "PI3K-Akt signaling pathway", "Melanogenesis"],
            "type": "circle",
            "label": "CREB3",
            "tag": "gene",
        ...
        {
            "id": "3511",
            "comment": ["SCLC", "nSCLC", "COLO", "PANC", "ENDO", "PROS"],
            "community": ["VEGF signaling pathway", "Pancreatic cancer", "Endometrial cancer", "Colorectal cancer", "Prostate cancer", "Non-small cell lung cancer", "Small cell lung cancer", "p53 signaling pathway", "PI3K-Akt signaling pathway", "Apoptosis"],
            "type": "circle",
            "label": "CASP9",
            "tag": "gene",
        ...
        {
            "id": "3510",
            "comment": ["CMLE", "nSCLC", "COLO", "ENDO", "PANC", "MELA", "AMLE", "PROS"],
            "community": ["Melanoma", "Acute myeloid leukemia", "VEGF signaling pathway", "Endometrial cancer", "Colorectal cancer", "Prostate cancer", "Non-small cell lung cancer", "Focal adhesion", "Chronic myeloid leukemia", "PI3K-Akt signaling pathway", "Pancreatic cancer", "Apoptosis", "ErbB signaling pathway"],
            "type": "circle",
            "label": "BAD",
            "tag": "gene",
        ...
        {
            "id": "3509",
            "comment": ["AMLE", "PANC", "PROS", "CMLE", "SCLC"],
            "community": ["Pancreatic cancer", "MAPK signaling pathway", "Prostate cancer", "Apoptosis", "Small cell lung cancer", "Acute myeloid leukemia", "Chronic myeloid leukemia", "mTOR signaling pathway", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "CHUK",
            "tag": "gene",
        ...
        {
            "id": "3507",
            "comment": ["MELA", "BRCA", "PROS", "GLIO", "BLAD", "PANC", "nSCLC", "ENDO"],
            "community": ["Melanoma", "Bladder cancer", "Focal adhesion", "Pancreatic cancer", "Endometrial cancer", "Calcium signaling pathway", "Estrogen signaling pathway", "Glioma", "Prostate cancer", "HIF-1 signaling pathway", "Cytokine-cytokine receptor interaction", "Adherens junction", "Non-small cell lung cancer", "ErbB signaling pathway", "MAPK signaling pathway", "PI3K-Akt signaling pathway", "Breast cancer"],
            "type": "circle",
            "label": "EGFR",
            "tag": "gene",
        ...
        {
            "id": "3506",
            "comment": ["nSCLC", "BLAD", "COLO", "PROS", "ENDO", "CMLE", "MELA", "GLIO", "BASA", "BRCA", "SCLC", "THYR", "PANC"],
            "community": ["Melanoma", "Bladder cancer", "Pancreatic cancer", "Endometrial cancer", "Colorectal cancer", "MAPK signaling pathway", "Thyroid cancer", "Basal cell carcinoma", "Glioma", "Prostate cancer", "Apoptosis", "Cell cycle", "p53 signaling pathway", "Non-small cell lung cancer", "Small cell lung cancer", "Chronic myeloid leukemia", "PI3K-Akt signaling pathway", "Wnt signaling pathway", "Breast cancer"],
            "type": "circle",
            "label": "TP53",
            "tag": "gene",
        ...
        {
            "id": "3505",
            "comment": ["nSCLC", "AMLE", "THYR", "PROS", "ENDO", "BRCA", "BLAD", "GLIO", "RENA", "CMLE", "MELA"],
            "community": ["Chronic myeloid leukemia", "Melanoma", "Jak-STAT signaling pathway", "Endometrial cancer", "PI3K-Akt signaling pathway", "Breast cancer", "Non-small cell lung cancer", "ErbB signaling pathway", "Acute myeloid leukemia", "Estrogen signaling pathway", "mTOR signaling pathway", "MAPK signaling pathway", "Bladder cancer", "Focal adhesion", "Renal cell carcinoma", "Thyroid cancer", "Glioma", "Prostate cancer", "Apoptosis", "VEGF signaling pathway", "Melanogenesis"],
            "type": "circle",
            "label": "HRAS",
            "tag": "gene",
        ...
        {
            "id": "3504",
            "comment": ["nSCLC", "PANC", "PROS", "GLIO", "BRCA", "MELA", "CMLE", "SCLC", "BLAD"],
            "community": ["Melanoma", "Bladder cancer", "Pancreatic cancer", "Cell cycle", "Glioma", "Prostate cancer", "Non-small cell lung cancer", "Small cell lung cancer", "Chronic myeloid leukemia", "Breast cancer"],
            "type": "circle",
            "label": "E2F1",
            "tag": "gene",
        ...
        {
            "id": "3503",
            "comment": ["ENDO", "BASA", "BRCA", "PROS", "THYR", "COLO"],
            "community": ["Endometrial cancer", "Colorectal cancer", "Thyroid cancer", "Basal cell carcinoma", "Prostate cancer", "Focal adhesion", "Adherens junction", "Melanogenesis", "Wnt signaling pathway", "Breast cancer"],
            "type": "circle",
            "label": "CTNNB1",
            "tag": "gene",
        ...
        },
        {
            "id": "3502",
            "comment": ["SCLC", "PROS"],
            "community": ["Cell cycle", "p53 signaling pathway", "Small cell lung cancer", "PI3K-Akt signaling pathway", "Prostate cancer"],
            "type": "circle",
            "label": "CDK2",
            "tag": "gene",
        ...
        {
            "id": "3500",
            "comment": ["BRCA", "GLIO", "CMLE", "BLAD", "PROS", "MELA"],
            "community": ["Melanoma", "Bladder cancer", "Cell cycle", "Glioma", "Prostate cancer", "Breast cancer", "Chronic myeloid leukemia", "HIF-1 signaling pathway", "Jak-STAT signaling pathway", "p53 signaling pathway", "PI3K-Akt signaling pathway", "ErbB signaling pathway"],
            "type": "circle",
            "label": "CDKN1A",
            "tag": "gene",
        ...
        {
            "id": "3499",
            "comment": ["BLAD", "CMLE", "PROS", "MELA", "GLIO"],
            "community": ["Melanoma", "Bladder cancer", "Cell cycle", "Glioma", "Prostate cancer", "Chronic myeloid leukemia", "p53 signaling pathway", "PI3K-Akt signaling pathway", "Ubiquitin mediated proteolysis"],
            "type": "circle",
            "label": "MDM2",
            "tag": "gene",
        ...
        },
        {
            "id": "3493",
            "comment": ["PROS", "RENA"],
            "community": ["TGF-beta signaling pathway", "Cell cycle", "Renal cell carcinoma", "Jak-STAT signaling pathway", "Adherens junction", "Melanogenesis", "HIF-1 signaling pathway", "Prostate cancer", "Notch signaling pathway", "Wnt signaling pathway"],
            "type": "circle",
            "label": "CREBBP",
            "tag": "gene",
        ...
        {
            "id": "3492",
            "comment": ["BASA", "COLO", "PROS", "ENDO", "BRCA", "AMLE", "THYR"],
            "community": ["Endometrial cancer", "Colorectal cancer", "Thyroid cancer", "Basal cell carcinoma", "Adherens junction", "Melanogenesis", "Acute myeloid leukemia", "Prostate cancer", "Wnt signaling pathway", "Breast cancer"],
            "type": "circle",
            "label": "LEF1",
            "tag": "gene",
        ...
        {
            "id": "3491",
            "comment": ["SCLC", "nSCLC", "BRCA", "CMLE", "MELA", "AMLE", "COLO", "GLIO", "ENDO", "PROS", "THYR", "BLAD", "PANC"],
            "community": ["Melanoma", "Hedgehog signaling pathway", "Focal adhesion", "Pancreatic cancer", "Endometrial cancer", "Colorectal cancer", "Thyroid cancer", "Glioma", "Jak-STAT signaling pathway", "Bladder cancer", "Wnt signaling pathway", "Cell cycle", "p53 signaling pathway", "Breast cancer", "Acute myeloid leukemia", "Chronic myeloid leukemia", "PI3K-Akt signaling pathway", "Prostate cancer", "Non-small cell lung cancer", "Small cell lung cancer"],
            "type": "circle",
            "label": "CCND1",
            "tag": "gene",
        ...
        {
            "id": "3490",
            "comment": ["SCLC", "COLO", "PROS"],
            "community": ["Hedgehog signaling pathway", "Colorectal cancer", "Jak-STAT signaling pathway", "Small cell lung cancer", "Focal adhesion", "HIF-1 signaling pathway", "Prostate cancer", "PI3K-Akt signaling pathway", "Apoptosis"],
            "type": "circle",
            "label": "BCL2",
            "tag": "gene",
        ...
        {
            "id": "3487",
            "comment": ["GLIO", "BRCA", "MELA", "ENDO", "PROS", "SCLC"],
            "community": ["Melanoma", "Endometrial cancer", "Glioma", "p53 signaling pathway", "Breast cancer", "Small cell lung cancer", "Focal adhesion", "Prostate cancer", "mTOR signaling pathway", "PI3K-Akt signaling pathway"],
            "type": "circle",
            "label": "PTEN",
            "tag": "gene",
        ...
        {
            "id": "3486",
            "comment": ["PROS", "SCLC", "CMLE"],
            "community": ["Cell cycle", "Prostate cancer", "Small cell lung cancer", "Chronic myeloid leukemia", "HIF-1 signaling pathway", "PI3K-Akt signaling pathway", "ErbB signaling pathway"],
            "type": "circle",
            "label": "CDKN1B",
            "tag": "gene",
        ...
        {
            "id": "3485",
            "comment": ["PROS", "CMLE", "SCLC"],
            "community": ["Prostate cancer", "Apoptosis", "Chronic myeloid leukemia", "Small cell lung cancer"],
            "type": "circle",
            "label": "NFKBIA",
            "tag": "gene",
        ...
        {
            "id": "3484",
            "comment": ["SCLC", "PROS", "PANC", "AMLE", "CMLE"],
            "community": ["Pancreatic cancer", "Chronic myeloid leukemia", "Prostate cancer", "HIF-1 signaling pathway", "PI3K-Akt signaling pathway", "Small cell lung cancer", "Acute myeloid leukemia", "Apoptosis", "MAPK signaling pathway"],
            "type": "circle",
            "label": "NFKB1",
            "tag": "gene",
        ...
        },
        {
            "id": "3482",
            "comment": ["PROS"],
            "community": ["Steroid hormone biosynthesis", "Prostate cancer"],
            "type": "circle",
            "label": "SRD5A2",
            "tag": "gene",
        ...
        },
        {
            ...
            "label": "PA",
            "tag": "compound",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?C00416"
        },
        {
            "id": "3696",
            "comment": ["BRCA"],
            "community": ["Prostate cancer", "Steroid hormone biosynthesis", "Breast cancer"],
            "type": "diamond",
            "label": "Progesterone",
            "tag": "compound",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?C00410"
        },
        {
            "id": "3686",
            "comment": ["BRCA"],
            "community": ["Prostate cancer", "Steroid hormone biosynthesis", "Breast cancer", "Estrogen signaling pathway"],
            "type": "diamond",
            "label": "Estradiol",
            "tag": "compound",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?C00951"
        },
        {
            "id": "3666",
            "comment": ["RENA"],
            ...
            "label": "Fumarate",
            "tag": "compound",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?C00122"
        },
        {
            "id": "3665",
            "comment": ["RENA"],
            ...
            "label": "Malate",
            "tag": "compound",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?C00149"
        },
        {
            "id": "3664",
            "comment": ["RENA"],
        ...
        },
        {
            "id": "3644",
            "comment": ["GLIO", "nSCLC"],
            "community": ["Glioma", "Estrogen signaling pathway", "MAPK signaling pathway", "ErbB signaling pathway", "VEGF signaling pathway", "Non-small cell lung cancer", "Calcium signaling pathway", "HIF-1 signaling pathway", "Melanogenesis"],
            "type": "diamond",
            "label": "DAG",
            "tag": "compound",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?C00165"
        },
        {
            "id": "3643",
            "comment": ["GLIO", "nSCLC"],
        ...
        },
        {
            ...
            "label": "Retinoic Acid",
            "tag": "compound",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?C00777+C15493"
        },
        {
            "id": "3544",
            "comment": ["BASA"],
            "community": ["Steroid hormone biosynthesis", "Basal cell carcinoma"],
            "type": "diamond",
            "label": "Cholesterol",
            "tag": "compound",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?C00187"
        },
        {
            "id": "3519",
        ...
        },
        {
            ...
            "label": "PhIP",
            "tag": "compound",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?C16038"
        },
        {
            "id": "3496",
            "comment": ["PROS"],
            "community": ["Prostate cancer", "Steroid hormone biosynthesis"],
            "type": "diamond",
            "label": "Testosterone",
            "tag": "compound",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?C00535"
        },
        {
            "id": "3495",
            "comment": ["PROS"],
            ...
            "tag": "compound",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?C03917"
        },
        {
            "id": "3494",
            "comment": ["PROS"],
            ...
            "label": "Other Ligands",
            "tag": "compound",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?C00951+C00410+C07653+C01227+C00280+C00735+C00762"
        },
        {
            "id": "3711",
            "comment": ["BRCA"],
            ...
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa03440"
        },
        {
            "id": "3695",
            "comment": ["BRCA"],
            ...
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04330"
        },
        {
            "id": "3688",
            "comment": ["BRCA"],
            "type": "square",
            "label": "Estrogen signaling pathway",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04915"
        },
        {
            "id": "3683",
            "comment": ["RENA"],
            "type": "square",
            "label": "HIF-1 signaling pathway",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04066"
        },
        {
            "id": "3682",
            "comment": ["RENA"],
            ...
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa00020"
        },
        {
            "id": "3681",
            "comment": ["RENA"],
            "type": "square",
            "label": "Ubiquitin mediated proteolysis",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04120"
        },
        {
            "id": "3653",
            "comment": ["GLIO", "nSCLC"],
            "type": "square",
            "label": "Calcium signaling pathway",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04020"
        },
        {
            "id": "3622",
            "comment": ["SCLC"],
            ...
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04510"
        },
        {
            "id": "3621",
            "comment": ["SCLC"],
            "type": "square",
            "label": "ECM-receptor interaction",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04512"
        },
        {
            "id": "3609",
            "comment": ["AMLE", "GLIO"],
            "type": "square",
            "label": "mTOR signaling pathway",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04150"
        },
        {
            "id": "3608",
            "comment": ["AMLE", "PANC"],
            "type": "square",
            "label": "Jak-STAT signaling pathway",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04630"
        },
        {
            "id": "3588",
            "comment": ["CMLE", "AMLE"],
            "type": "square",
            "label": "Hematopoietic cell lineage",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04640"
        },
        {
            "id": "3568",
            "comment": ["PANC", "ENDO", "nSCLC", "GLIO", "BLAD"],
            "type": "square",
            "label": "ErbB signaling pathway",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04012"
        },
        {
            "id": "3567",
            "comment": ["BLAD", "RENA", "PANC"],
            "type": "square",
            "label": "VEGF signaling pathway",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04370"
        },
        {
            "id": "3561",
            "comment": ["MELA"],
            ...
            "label": "Melanogenesis",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04916"
        },
        {
            "id": "3560",
            "comment": ["RENA", "PANC", "CMLE", "BASA", "COLO"],
            "type": "square",
            "label": "TGF-beta signaling pathway",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04350"
        },
        {
            "id": "3559",
            "comment": ["BASA"],
            ...
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04340"
        },
        {
            "id": "3542",
            "comment": ["COLO", "ENDO", "THYR", "BRCA", "BASA"],
            "type": "square",
            "label": "Wnt signaling pathway",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04310"
        },
        {
            "id": "3541",
            "comment": ["BLAD", "MELA", "ENDO", "THYR"],
            "type": "square",
            "label": "Adherens junction",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04520"
        },
        {
            "id": "3540",
            "comment": ["THYR"],
            "type": "square",
            "label": "PPAR signaling pathway",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa03320"
        },
        {
            "id": "3531",
            "comment": ["SCLC", "PROS", "CMLE", "COLO", "MELA", "nSCLC", "BRCA", "AMLE", "PANC", "ENDO"],
            "type": "square",
            "label": "PI3K-Akt signaling pathway",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04151"
        },
        {
            "id": "3523",
            "comment": ["CMLE", "MELA", "GLIO", "ENDO", "THYR", "COLO", "PROS", "AMLE", "RENA", "BRCA", "BLAD", "PANC", "nSCLC"],
            "type": "square",
            "label": "MAPK signaling pathway",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04010"
        },
        {
            "id": "3508",
            "comment": ["AMLE", "PROS", "COLO", "SCLC", "CMLE", "PANC"],
            "type": "square",
            "label": "Apoptosis",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04210"
        },
        {
            "id": "3497",
            "comment": ["MELA", "nSCLC", "SCLC", "GLIO", "BRCA", "PROS", "AMLE", "COLO", "BLAD", "PANC", "BASA", "ENDO", "CMLE"],
            "type": "square",
            "label": "Cell cycle",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04110"
        },
        {
            "id": "3481",
            "comment": ["PROS"],
            ...
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa00140"
        },
        {
            "id": "3480",
            "comment": ["ENDO", "GLIO", "PROS"],
            "type": "square",
            "label": "Cytokine-cytokine receptor interaction",
            "tag": "map",
            "url": "http://www.kegg.jp/dbget-bin/www_bget?hsa04060"
        },
        {
            "id": "3479",
            "comment": ["PROS", "nSCLC", "SCLC", "ENDO", "BRCA", "GLIO", "THYR", "COLO", "CMLE", "PANC", "BLAD", "MELA", "BASA"],
            "type": "square",
...
var PATHWAYS =[];//contains cancer labels
const CANCER_DATA = [
    {
        "id": "AMLE",
        "key": 0,
    ...
    {"id": "BLAD", "key": 2, "value": 0, "color": "#6b6ecf", "name": "Bladder Cancer", "genes": [], "values": []},
    {"id": "BRCA", "key": 3, "value": 0, "color": "#9c9ede", "name": "Breast Cancer", "genes": [], "values": []},
    {
        "id": "CMLE",
        "key": 4,
        "value": 0,
    ...
    {"id": "GLIO", "key": 7, "value": 0, "color": "#cedb9c", "name": "Glioma", "genes": [], "values": []},
    {"id": "MELA", "key": 8, "value": 0, "color": "#8c6d31", "name": "Melanoma", "genes": [], "values": []},
    {
        "id": "nSCLC",
        "key": 9,
        "value": 0,
    ...
    {"id": "PROS", "key": 10, "value": 0, "color": "#e7ba52", "name": "Prostate Cancer", "genes": [], "values": []},
    {
        "id": "PANC",
        "key": 11,
        "value": 0,
    ...
    {"id": "THYR", "key": 14, "value": 0, "color": "#CE616C", "name": "Thyroid Cancer", "genes": [], "values": []}
]
var VISIBLEGENES =[];
GLOBALDATA.nodes.map((d, i) => d.index = i); //Append index to nodes

//General statistics
let genesList = GLOBALDATA.nodes.filter(d => d.tag === 'gene');
let compoundList = GLOBALDATA.nodes.filter(d => d.tag === 'compound');
let mapList = GLOBALDATA.nodes.filter(d => d.tag === 'map');
$("#totalGenes").text(genesList.length);
$("#totalCompound").text(compoundList.length);
$("#totalMaps").text(mapList.length);
//End of statistics

//Populate sidebar pathway

let sidebarPathway = $("#control-sidebar-settings-tab");
mapList.forEach(el => {
    ...
    _input.title = el.label;
    _input.setAttribute("index",el.index)
    _input.className = "pull-right";
    _input.onchange = mapElClicked;
    label.appendChild(_input)
    sidebarPathway.append(label)
});
function mapElClicked(){
    if(this.checked){
        let nodeIndex = +this.getAttribute("index");
        let pathways = GLOBALDATA.nodes[nodeIndex].comment;
        PATHWAYS = _.union(PATHWAYS, pathways)

    }else{
        let nodeIndex = +this.getAttribute("index");
        let pathways = GLOBALDATA.nodes[nodeIndex].comment;
        PATHWAYS = _.without(PATHWAYS, ...pathways)
        pathways.forEach(p=>{
            d3.select(`.state[title=${p}]`).classed("selected",false);
            let _genes = CANCER_DATA.find(x=>x.id===p).genes;
            VISIBLEGENES = _.without(VISIBLEGENES, ..._genes)
        })
    }
    updateBubbleChart()
...
function updateBubbleChart(){
    PATHWAYS.forEach(cancer=>{
        d3.select(`.state[title=${cancer}]`).classed("selected",true);
        let _genes = CANCER_DATA.find(x=>x.id===cancer).genes;
        VISIBLEGENES = _.union(VISIBLEGENES, _genes)
    });
    updateNetwork();
}

function updateNetwork(){
    let g = d3.select("g#global_G");
    ...
    selectedlinks.style("opacity", function (d) {
        if (VISIBLEGENES.indexOf(d.source.id) === -1 || VISIBLEGENES.indexOf(d.target.id) === -1) return 0.09
    })
    selectednodes.style("opacity", function (d) {
        if (VISIBLEGENES.indexOf(d.id) === -1) return 0.09;
    });
    selectedtext.style("opacity", function (d) {
        if (VISIBLEGENES.indexOf(d.id) === -1) return 0.09;
    });
}
//End of populate sidebar pathway

//Populate sidebar compound
let sidebarCompound = $("#control-sidebar-home-tab");
compoundList.forEach(el => {
    let label = document.createElement("label")
    label.className = "control-sidebar-subheading";
...
function RenderBubbleChart() {
    ...
    GLOBALDATA.nodes.forEach(function (d) {
        d.comment.forEach(function (e) {
            CANCER_DATA.forEach(function (f) {
                if (e === f.id) {
                    f.genes.push(d.id);
                    f.values.push(d);
    ...
    let nodes = bubble.nodes({children: CANCER_DATA}).filter(function (d) {
        return !d.children;
    });
...
function UpdateGenesNetwork() {
    ...
    var keyc = true, keys = true, keyt = true, keyr = true, keyx = true, keyd = true, keyl = true, keym = true,
    ...
    for (var linkitem = 0; linkitem < GLOBALDATA.links.length; linkitem++) {
        for (var nodeItem = 0; nodeItem < GLOBALDATA.nodes.length; nodeItem++) {

            if (GLOBALDATA.nodes[nodeItem].id == GLOBALDATA.links[linkitem].source) {
                GLOBALDATA.links[linkitem].source = nodeItem;
            }
            if (GLOBALDATA.nodes[nodeItem].id == GLOBALDATA.links[linkitem].target) {
                GLOBALDATA.links[linkitem].target = nodeItem;
            }
        }
    }
    force
    ...
    function update(nodes, links) {
        ...
        var circle = node.append("path").attr("class", "circle_path").attr("id", function (d) {
            return "g" + d.id;
        })
    ...
    function update_transparent(protein) {
        ...
        var selectedtext = g.selectAll(".text");
        selectedlinks.style("opacity", function (d) {
            if (protein.indexOf(d.source.id) === -1 || protein.indexOf(d.target.id) === -1) return 0.09
        })
        selectednodes.style("opacity", function (d) {
            if (protein.indexOf(d.id) === -1) return 0.09;
        });
        selectedtext.style("opacity", function (d) {
            if (protein.indexOf(d.id) === -1) return 0.09;
        });
    ...
    function update_intersection(intersection) {
        var selectednodes = g.selectAll(".node");
        var selectedlinks = g.selectAll(".link");
        var selectedtext = g.selectAll(".text");
        selectedlinks.style("opacity", function (d) {
            if (intersection.indexOf(d.source.id) >= 0 && intersection.indexOf(d.target.id) >= 1) return 0.09
        })
        selectednodes.style("opacity", function (d) {
            if (intersection.indexOf(d.id) === -1) return 0.09;
        });
        selectedtext.style("opacity", function (d) {
            if (intersection.indexOf(d.id) === -1) return 0.09;
        });
    ...
    update(GLOBALDATA.nodes, GLOBALDATA.links);
    ...
    bubblechart.on("click", function (d, i) {
        ...
        selectedvalue.each(function (d, i) {
            ...
            d.genes.forEach(function (e) {
                d3.select('#g' + e).style("fill", d.color)                 // Change the color of the element
            })
            groups.push({"key": d.key, "id": d.id, "values": d.values, "color": d.color})
        });

        var protein = store_protein[0];
        var intersect = store_protein[0];
        for (i = 1; i < store_protein.length; i++) {
            protein = _.union(protein, store_protein[i])
            intersect = _.intersection(intersect, store_protein[i])
        }
        if (store_protein.length > 1) {
            intersect.forEach(function (d) {
                d3.select('#g' + d).style("fill", "black").attr("d", d3.svg.symbol().size(1000))
            })
        } else {
            intersect.forEach(function (d) {
                d3.select('#g' + d).attr("d", d3.svg.symbol().size(340))
            })
        }

        var node_filter = GLOBALDATA.nodes.filter(function (d) {
        ...
        // update(node_filter, newlink)
        // bubbleset(node_filter,newlink);
...
//End of drawing force directed graph
